...
import { HeaderCaption, Heading, HeaderContainer, SmallCaption, Group, HomeImage, MobileButton } from './HomeElement'
    ...
    return(
        <>
            <HeaderContainer>
                ...
                <MobileButton><SecondaryButton fill="126px" bottom="31px">Sign Up </SecondaryButton></MobileButton>
            </HeaderContainer>
